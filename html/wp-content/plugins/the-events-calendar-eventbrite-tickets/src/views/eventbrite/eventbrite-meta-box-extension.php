...
<?php endif; ?>
	...
	<tr>
		...
		<td>
			<select id='EventBriteImageSyncMode' tabindex="<?php $tribe_ecp->tabIndex(); ?>" name='EventBriteImageSyncMode'>
				...
				<option value="-1" <?php selected( $image_sync_mode, -1 ); ?>><?php echo esc_html_x( 'Never syncronize the images', 'image sync', 'tribe-eventbrite' ); ?></option>
			</select>
		</td>
	</tr>
 <?php } ?>
