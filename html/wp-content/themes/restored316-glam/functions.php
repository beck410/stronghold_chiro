...
define( 'CHILD_THEME_NAME', 'Stronghold Health' );
define( 'CHILD_THEME_URL', 'http://strongholdhealth.com' );
...
function custom_footer_creds_text() {
    ...
    echo 'Copyright &copy; ';
    echo date('Y');
    echo ' &middot; <a target="_blank" href="http://stongholdhealth.com/">Stronghold Chiropractic</a> Designed by <a target="_blank" href="http://www.StellaCadenteENT.com">Stella Cadente</a>';
    echo '</p></div>';
